 ...
 * Includes only relevant items for the Advantis Agents app.
 *
...
export async function rebuildMenu(): Promise<void> {
  ...
  const template: Electron.MenuItemConstructorOptions[] = [
    // App menu (macOS only)
    ...(isMac ? [{
      label: 'Advantis Agents',
      submenu: [
        { role: 'about' as const, label: 'About Advantis Agents' },
        updateMenuItem,
        ...
        { type: 'separator' as const },
        { role: 'hide' as const, label: 'Hide Advantis Agents' },
        { role: 'hideOthers' as const },
        { role: 'unhide' as const },
        { type: 'separator' as const },
        { role: 'quit' as const, label: 'Quit Advantis Agents' }
      ]
    }] : []),
