    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 min-h-0 mask-fade-y">
        <ScrollArea className="h-full">
          ...
          <SettingsSection
            title="Basic Info"
            description="Help Advantis Agents personalize responses to you."
          >
            <SettingsCard divided>
              <SettingsInput
                label="Name"
                description="How Advantis Agents should address you."
              ...
              <SettingsInput
                label="Language"
                description="Preferred language for Advantis Agents responses."
          ...
          <SettingsSection
            title="Notes"
            description="Free-form context that helps Advantis Agents understand your preferences."
            action={
          ...
          >
            <SettingsCard divided={false}>
              <SettingsTextarea
                ...
                placeholder="Any additional context you'd like Advantis Agents to know..."
                rows={5}
                inCard
              />
            </SettingsCard>
